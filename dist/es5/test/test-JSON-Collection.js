...
ava_1.default("JSON SERIALIZE: BelongsTo.Series => Collection[]", function (t) {
...
ava_1.default("JSON SERIALIZE: BelongsTo.Series => Collection[1] collapse-array", function (t) {
    var b = new metadata_belongsto_1.BelongsTo();
    b.Series = [col1];
    helpers_1.inspect(b);
    var json = ta_json_x_1.JSON.serialize(b);
...
ava_1.default("JSON DESERIALIZE: BelongsTo.Series => Collection[]", function (t) {
    var json = {};
...
ava_1.default("JSON DESERIALIZE: BelongsTo.Series => Collection[1]", function (t) {
    var json = {};
...
ava_1.default("JSON DESERIALIZE: BelongsTo.Series => CollectionSTR[]", function (t) {
    var json = {};
...
ava_1.default("JSON DESERIALIZE: BelongsTo.Series => CollectionSTR[1]", function (t) {
    var json = {};
